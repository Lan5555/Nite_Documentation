...
export const prefersDark = window.matchMedia('(prefers-color-scheme: dark)').matches && condition == 'dark';
...
export const prefersDark2 = window.matchMedia('(prefers-color-scheme: dark)').matches;